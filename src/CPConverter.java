  ...
  implements Runnable
{
    ...
    throws FileNotFoundException, IOException
  {
    ...
    while (( line = localBufferedReader.readLine()) != null)
    {
      ...
      if (split.length > 5)
        str2 = split[5].trim();
      log(String.format("Registering chest to %s at location {%d,%d,%d}", new Object[] { str1, Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n) }));
